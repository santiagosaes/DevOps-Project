...
1. Attach all three volumes one by one to your Web Server EC2 instance . The instance must be ON
...
![attach](https://github.com/santiagosaes/DevOps-Project/blob/main/6%20-%20WebSolutionWordpress/images/MOUNTEDDISKS.png)
...
Command (? for help branch segun-edits: n (create new partition)
